...
const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  (
    ...
    const baseStyles = 'block w-full rounded-full border-2 bg-white px-4 py-3.5 text-sm font-medium material-transition focus:outline-none focus:ring-2 focus:ring-primary-500/20 disabled:opacity-50 disabled:cursor-not-allowed resize-none shadow-sm';
