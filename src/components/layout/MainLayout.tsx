  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/admin/depreciation', label: 'الإهلاك', icon: 'calendar_month', badge: null },
    ...
    >
      ...
      <header
        ...
        style={{
          ...
          backgroundColor: isDarkMode ? 'rgba(15, 23, 42, 0.72)' : 'rgba(255, 255, 255, 0.72)',
          borderBottom: isDarkMode ? '1px solid rgba(71, 85, 105, 0.55)' : '1px solid rgba(226, 232, 240, 0.6)',
            ...
            {user && (
              <div className="flex items-center gap-2 sm:gap-3 relative">
                ...
                <button
                  ...
                  className={`p-2.5 rounded-xl material-transition cursor-pointer group relative overflow-hidden shadow-sm hover:shadow-md hover:scale-[1.03] active:scale-95 border ${isDarkMode
                    ? 'bg-slate-900/60 hover:bg-slate-900 text-slate-200 hover:text-primary-300 border-slate-700/60'
                    : 'bg-white/80 hover:bg-primary-50 text-slate-600 hover:text-primary-600 border-slate-200/60'
                    }`}
                ...
                <div className="hidden sm:block relative" ref={profileDropdownRef}>
                  <button
                    ...
                    className={`flex items-center gap-3 px-3.5 py-2.5 rounded-xl material-transition cursor-pointer group relative overflow-hidden ${isProfileDropdownOpen
                      ? 'bg-gradient-to-r from-primary-50 to-primary-100/50 shadow-lg ring-2 ring-primary-500/20'
                      : isDarkMode
                        ? 'bg-slate-900/60 hover:bg-slate-900 shadow-sm hover:shadow-lg hover:ring-2 hover:ring-primary-500/10'
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start min-w-0 max-w-[170px] relative z-10">
                      <span className={`text-sm font-bold truncate w-full text-right material-transition ${isProfileDropdownOpen ? 'text-primary-700' : 'text-slate-900 group-hover:text-primary-700'
                        }`}>
                        {user.get('full_name') || user.get('username')}
                      </span>
                      <span className={`text-xs truncate w-full text-right font-semibold material-transition ${isProfileDropdownOpen ? 'text-primary-600' : 'text-slate-500 group-hover:text-primary-600'
                        }`}>
                    ...
                    <MaterialIcon
                      ...
                      className={`material-transition transition-all duration-300 relative z-10 ${isProfileDropdownOpen
                  ...
                  {isProfileDropdownOpen && (
                    <div
                      className={`absolute left-0 mt-3 w-80 rounded-2xl shadow-2xl border-2 overflow-hidden animate-scale-in backdrop-blur-xl ${isDarkMode
                      ...
                      style={{
                        ...
                        background: isDarkMode
                          ? 'linear-gradient(to bottom, rgba(15, 23, 42, 0.98), rgba(30, 41, 59, 0.98))'
                          : 'linear-gradient(to bottom, rgba(255, 255, 255, 0.98), rgba(250, 250, 252, 0.98))',
                      }}
                    >
                      ...
                      <div className="py-3 px-2">
                        <button
                          ...
                          className={`w-full flex items-center justify-between gap-3 px-4 py-3.5 text-right text-sm font-semibold material-transition cursor-pointer rounded-xl mx-1.5 group relative overflow-hidden ${isDarkMode
                            ? 'text-slate-200 hover:bg-slate-800/60 hover:text-primary-300'
                            : 'text-slate-700 hover:bg-gradient-to-l hover:from-primary-50 hover:to-transparent hover:text-primary-700'
                            }`}
                        >
                        ...
                        {/* Separator - أنيق */}
                        <div className={`mx-4 my-2 h-px bg-gradient-to-r from-transparent ${isDarkMode ? 'via-slate-700' : 'via-slate-200'} to-transparent`}></div>
                        ...
                        <button
                          ...
                          className={`w-full flex items-center justify-between gap-3 px-4 py-3.5 text-right text-sm font-semibold material-transition cursor-pointer rounded-xl mx-1.5 group relative overflow-hidden ${isDarkMode
                            ? 'text-slate-200 hover:bg-error-900/20 hover:text-error-300'
                            : 'text-slate-700 hover:bg-gradient-to-l hover:from-error-50 hover:to-transparent hover:text-error-700'
                            }`}
                        >
                          {/* Hover effect background */}
                ...
                <div className="sm:hidden relative" ref={profileDropdownRef}>
                  <button
                    ...
                    className={`p-2 rounded-xl material-transition cursor-pointer ${isProfileDropdownOpen
                      ? 'bg-primary-50 shadow-md ring-2 ring-primary-500/20'
                      : isDarkMode
                        ? 'bg-slate-900/60 hover:bg-slate-900 shadow-sm hover:shadow-md'
      ...
      <div className="flex flex-1 overflow-hidden">
                    ...
                    >
                      ...
                      <ul className="space-y-1 px-3" role="menubar">
                        {visibleItems.map((item, itemIndex) => {
                          ...
                          // عرض أيقونة فتح في تبويب جديد لجميع الصفحات
                          const shouldShowNewTabIcon = true;
                          ...
                          return (
                            ...
                            >
                              <Link
                                ...
                                className={`flex items-center gap-3 sm:gap-3.5 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl material-transition text-sm font-semibold relative group overflow-hidden min-h-[44px] focus:outline-none focus:ring-2 focus:ring-primary-500/50 ${isActive
                                  ? 'text-primary-700 dark:text-primary-300 bg-gradient-to-r from-primary-50 via-primary-100/70 to-primary-50 dark:from-primary-900/30 dark:via-primary-800/20 dark:to-primary-900/30 shadow-lg shadow-primary-500/15 ring-1 ring-primary-500/20'
                                  : 'text-slate-700 dark:text-slate-200 hover:bg-gradient-to-r hover:from-slate-50/80 hover:via-primary-50/40 hover:to-slate-50/80 dark:hover:from-slate-800/40 dark:hover:via-primary-900/20 dark:hover:to-slate-800/40 hover:text-primary-700 dark:hover:text-primary-300 hover:shadow-md hover:ring-1 hover:ring-primary-500/10 active:bg-primary-50 dark:active:bg-slate-800/40'
                                  }`}
                                onClick={() => setSidebarOpen(false)}
                                onKeyDown={(e) => {
                              ...
                              >
                                ...
                                <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center material-transition relative z-10 flex-shrink-0 ${isActive
                                  ...
                                  : 'bg-slate-100/80 dark:bg-slate-800/60 text-slate-600 dark:text-slate-300 group-hover:bg-gradient-to-br group-hover:from-primary-100 group-hover:via-primary-200 group-hover:to-primary-100 dark:group-hover:from-primary-900/30 dark:group-hover:via-primary-800/20 dark:group-hover:to-primary-900/30 group-hover:text-primary-700 dark:group-hover:text-primary-300 group-hover:scale-110 group-hover:shadow-lg group-hover:ring-1 group-hover:ring-primary-500/20 active:scale-95'
                                  }`}
                                  style={{
                                ...
                                {/* Label - Enhanced */}
                                <span className={`truncate flex-1 relative z-10 material-transition ${isActive
                                ...
                                {/* Badge - Hot/New */}
                                {item.badge && (
                                  <span className={`px-2 py-0.5 text-[10px] font-black uppercase rounded-md ${item.badge === 'hot'
                              ...
                              {shouldShowNewTabIcon && (
                                <button
                                  ...
                                  className={`absolute left-2 top-1/2 -translate-y-1/2 w-7 h-7 rounded-lg flex items-center justify-center opacity-0 group-hover/item:opacity-100 group-hover:opacity-100 material-transition shadow-md hover:shadow-lg hover:scale-110 active:scale-95 z-20 border hover:border-primary-300 ${isDarkMode
                                    ? 'bg-slate-900/80 hover:bg-slate-800 text-slate-200 hover:text-primary-300 border-slate-700'
                                    : 'bg-white/90 hover:bg-primary-50 text-slate-600 hover:text-primary-600 border-slate-200'
                                    }`}
        ...
        <main
          ...
          style={{
            background: isDarkMode
              ? 'linear-gradient(to bottom, #0f172a 0%, #111827 50%, #0b1220 100%)'
              : 'linear-gradient(to bottom, #f8f7fa 0%, #f5f4f7 50%, #f0eff2 100%)',
      ...
      {user && (
        ...
        >
          <MaterialIcon name="keyboard" size="xl" className="group-hover:scale-110 material-transition" />
        </button>
      )}
    </div>
  );
